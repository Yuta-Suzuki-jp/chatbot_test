...
const useCases = {
  suntory: {
    ...
    articleTitle: 'サントリーウエルネス、大人の男性向けスキンケア「VARON」を発売 - 10日間体験で顔印象が変わる',
    articleContent: [
      'サントリーウエルネスは、40代以上の大人の男性に向けたオールインワンスキンケア商品「VARON(ヴァロン)」を発売した。長年の研究に基づき、男性特有の肌の悩みにアプローチする。',
      '多くのミドルシニア男性はスキンケアの習慣がないが、実は男性の肌は女性に比べて水分量が少なく、皮脂量が多いため、乾燥やテカリなどのトラブルが起きやすい状態にあるという。',
      '同社が独自に開発した「WOW(水相・油相・水相)高浸透型エマルジョン」技術により、化粧水、美容液、乳液の役割を1本で果たす。ウイスキー原酒の熟成に用いられるオーク樽の木材から抽出したエキスなども配合されている。',
      'オンライン会議の普及などにより、自分自身の「顔」を見る機会が増えた現在、ビジネスパーソンにとって「清潔感」や「若々しい印象」は重要な武器となる。VARONはそんな大人の男性の自己投資をサポートする狙いだ。'
    ],
    agentName: '先生のタナカ',
    agentTitle: 'Suntory Wellness 公式AIエージェント',
    scenarios: {
      step1: {
  ...
  persol: {
    ...
    articleContent: [
      ...
      '本記事では、プロ人材向けサービス「HiPro」を通じて見えてきた、独立や副業を成功させるために必要なステップと、適正な報酬を得るためのポイントについて解説する。'
    ],
    agentName: '先生のタナカ',
    agentTitle: 'HiPro 公式キャリアアドバイザー',
    scenarios: {
      step1: {
  ...
  honda: {
    ...
    mediaName: 'Discover Honda',
    mediaCategory: '先進モビリティ',
    articleDate: '2024/01/20 10:00',
    articleTitle: 'クルマとスマホが繋がる時代。「Honda CONNECT」がもたらす新しいカーライフの形',
    articleContent: [
      '自動車のコネクテッド化が急速に進む中、Hondaが提供する新世代コネクテッド技術「Honda CONNECT」がドライバーの日々の体験を大きく変えようとしている。',
      '専用スマートフォンアプリ「My Honda」を通じて、離れた場所からのエアコン操作や、ドアロックの確認・操作が可能に。寒い冬や暑い夏に、乗車前から快適な車内空間を準備できるのは大きなメリットだ。',
    ...
    scenarios: {
      ...
      step5: {
        text: 'ありがとうございます！『My Honda』アプリは、ホンダオーナー様なら無料でご利用いただける公式アプリです。\n駐車場での迷子防止だけでなく、ドライブの記録を残せたり、デジタル説明書として使えたりと、カーライフを剧的に快適にする機能が詰まっています。\n万が一のトラブルへの『お守り』としても、次回のお出かけ前にぜひダウンロードしておきませんか？',
        isFinal: true,
        finalActionText: '無料アプリをダウンロードして機能を見る',
        finalActionUrl: '#',
        finalActionAlert: 'My Hondaアプリのダウンロードページ（App Store / Google Play 等）へ遷移します。',
