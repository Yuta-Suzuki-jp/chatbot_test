  ...
  card: {
    ...
    scenarios: {
      step1: {
        ...
        options: [
          { text: '【緊急】車の修理代・急な冠婚葬祭など、予想外の出費が発生して今すぐお金が必要', next: 'step2' },
          { text: '【先取り】給料日前に旅行や欲しい家電がある。賢く「今すぐ手に入れる」方法を知りたい', next: 'step2' },
          { text: '【見直し】すでに他社で借りているが、金利が高い気がする。もっと良い条件に乗り換えたい', next: 'step2' }
        ]
      },
      step2: {
